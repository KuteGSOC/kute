package com.scorelab.kute.kute.Miscelleneous;
...
public class FabMenu {
    ...
    public void playEnterAnimation(final Button button, int position, final TextView textView) {
    ...
    public void playExitAnimation(final Button button, int position, final TextView textView) {
